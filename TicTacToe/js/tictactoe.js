...
let activePlayer='X';
//stores an array of moves, which we will use to determine win conditions
let selectedSquares=[];

//this function is for placing an X or O in a square
function placeXOrO(squareNumber) {
//ensures a square hasn't been selected already - the .some() method is used to check each element of the selectSquare array to see if it contains the square number clicked on.
...
//takes a string parameter of the path set earlier for placement sound('.media/place.mp3')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //this condition is similar to the one above and is necessary for the 6, 4, 2 win conditions
    ...
    function clear() {
        //this line starts our anmation loop
