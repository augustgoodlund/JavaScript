...
const Calculator = {
    ...
    First_Operand: null,
    //this chekcs whether or not the second operand has been input by user
...
function Input_Digit(digit) {
    ...
    //checks if the Wait_Second_Operand is true and sets Display_Value to the key that was clicked on
...
function Input_Decimal(dot) {
    //ensures that accidental clicking of the decimal point doesn't cause bugs
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //If operator exists, property lookup is performed for the operator in the Perform_Calculation object and the function tha tmatches the operator is executed
        let result = Perform_Calculation[operator](Value_Now, Value_of_Input);
        //here we add the fixed amount of numbers after the decimal
...
//updates the calculator screen with contents of Display_Value
